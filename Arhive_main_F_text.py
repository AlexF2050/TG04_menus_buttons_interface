...
async def start(message: Message):
    await message.answer(f"Доброго времени, {message.from_user.first_name} напиши мне любой текст, и я переведу его на английский язык.", reply_markup=kb.main)  # , reply_markup=kb.inline_keyboard_test или reply_markup=kb.main или reply_markup=await kb.test_keyboard()
